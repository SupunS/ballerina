...
public class SymbolEnter extends BLangNodeVisitor {
    ...
    private void defineReferencedFunction(BLangTypeDefinition typeDef, SymbolEnv objEnv, BLangType typeRef,
        ...
        BInvokableSymbol funcSymbol = ASTBuilderUtil.duplicateInvokableSymbol(function.symbol);
        funcSymbol.owner = typeDef.symbol;
        funcSymbol.name = funcName;
        defineSymbol(typeRef.pos, funcSymbol, objEnv);

        // Create and define the receiver. This should be done after defining the function symbol.
